...
class AINetworkService {
    ...
    func analyzeMealImage(_ image: UIImage, userInput: String? = nil) async throws -> String {
            ...
            "messages": [
                [
                    ...
                    "content": [
                        [
                            "type": "text",
                            "text": "Analyze this food image and provide a detailed breakdown in the following format:\n\nMain Dish: [Name of the main dish]\n\nIngredients: [List of ingredients with their approximate percentage in the dish, one per line starting with '-']\n\nNutritional Information (per 100g):\n   - Carbohydrates: [X.X]g\n   - Starch: [X.X]g\n   - Proteins: [X.X]g\n   - Fats: [X.X]g\n   - Seed Oils: [X.X]g\n   - Sugars: [X.X]g\n   - Fiber: [X.X]g\n   - Energy (kcal): [X.X]kcal\n   - Saturated Fat: [X.X]g\n   - Sodium: [X.X]g\n\nPortion Size: [Estimated portion size]\n\nHealth Metrics:\n   - Junk Score: [X] (0-10, where 0 is healthiest)\n   - Added Sugars: [X.X]g\n   - Refined Carbs: [X.X]g\n   - Processed Ingredients: [List of processed ingredients]\n\nAdditional Notes: [Any other relevant information]\(userInput.map { "\n\nAdditional User Input: \($0)" } ?? "")\n\nIf exact values cannot be determined, provide reasonable estimates based on typical values for similar foods. The response should be structured to easily create an OpenFoodFacts Product object while maintaining important health metrics."
                        ],
                        [
                            "type": "image_url",
                            "image_url": [
