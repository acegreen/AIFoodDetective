...
struct Product: Codable, Identifiable, Hashable, Equatable {
    ...
    var junkScore: Double {
        ...
        let sugars = nutriments?.addedSugars ?? 0
    ...
    static func createFromAIAnalysis(result: String, image: UIImage?) -> Product {
        ...
        let nutriments = Nutriments.fromAI(
            ...
            addedSugars: analysis.healthMetrics.addedSugars,
...
struct Nutriments: Codable {
    ...
    var addedSugars: Double? { addedSugars_value }
    ...
    private let addedSugars_value: Double?
    private let addedSugars_unit: String?
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case addedSugars_value = "added-sugars_value"
        case addedSugars_unit = "added-sugars_unit"
